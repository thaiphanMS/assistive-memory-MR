...
namespace SysUX.DockArea//Microsoft.MixedReality.Toolkit.UI
{
    /// <summary>
    ...
    public class Billboard : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            {
                targetTransform = Camera.main.transform;//CameraCache.Main.transform;
            }
        }
        ...
        private void Update()
        {
            ...
            {
                transform.rotation = Quaternion.LookRotation(-directionToTarget, Camera.main.transform.up); //CameraCache.Main.transform.up);
            }
            else
            {
